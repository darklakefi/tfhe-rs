...
void cuda_convert_lwe_programmable_bootstrap_key(hipStream_t stream,
                                                 uint32_t gpu_index,
  ...
  double2 *h_bsk;
  hipHostMalloc((void **)&h_bsk, buffer_size);
...
void convert_u128_to_f128_and_forward_fft_128(hipStream_t stream,
