...
void cuda_convert_lwe_programmable_bootstrap_key_32(
  ...
  cuda_convert_lwe_programmable_bootstrap_key<uint32_t, int32_t>(
      static_cast<hipStream_t>(stream), gpu_index, (double2 *)dest,
...
void cuda_fourier_polynomial_mul(void *stream_v, uint32_t gpu_index,
  ...
  auto stream = static_cast<hipStream_t>(stream_v);
  ...
  case 256:
    if (shared_memory_size <= max_shared_memory) {
      ...
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<256>, ForwardFFT>,
                               FULLSM>),
  ...
  case 512:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<521>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<512>, ForwardFFT>,
                               FULLSM>),
          hipFuncCachePreferShared));
  ...
  case 1024:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<1024>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<1024>, ForwardFFT>,
  ...
  case 2048:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<2048>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<2048>, ForwardFFT>,
  ...
  case 4096:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<4096>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<4096>, ForwardFFT>,
  ...
  case 8192:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<8192>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<8192>, ForwardFFT>,
  ...
  case 16384:
    if (shared_memory_size <= max_shared_memory) {
      buffer = (double2 *)cuda_malloc_async(0, stream, gpu_index);
      check_cuda_error(hipFuncSetAttribute(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<16384>, ForwardFFT>,
                               FULLSM>),
          hipFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size));
      check_cuda_error(hipFuncSetCacheConfig(
          reinterpret_cast<const void*>(batch_polynomial_mul<FFTDegree<AmortizedDegree<16384>, ForwardFFT>,
...
void cuda_convert_lwe_programmable_bootstrap_key_u128(
    hipStream_t stream, uint32_t gpu_index, double *dest,
...
void cuda_convert_lwe_programmable_bootstrap_key_128(
  ...
  cuda_convert_lwe_programmable_bootstrap_key_u128(
      static_cast<hipStream_t>(stream), gpu_index, (double *)dest,
